  ...
  _createClass(Check, [{
    ...
    value: function from(endpoint) {
      ...
      if (this._endpointArr.length <= 1) {
        ...
        return !!((_acl$_roles$this$_rol = acl._roles[this._role]) === null || _acl$_roles$this$_rol === void 0 ? void 0 : (_acl$_roles$this$_rol2 = _acl$_roles$this$_rol[this._http_verb]) === null || _acl$_roles$this$_rol2 === void 0 ? void 0 : _acl$_roles$this$_rol2.some(function (item) {
          return item.endpoint === endpoint;
        }));
      }
